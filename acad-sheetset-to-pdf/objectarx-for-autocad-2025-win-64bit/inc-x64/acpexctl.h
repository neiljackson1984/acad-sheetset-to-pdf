...
#ifndef __AcPePropertyEditorBlockName_FWD_DEFINED__
#define __AcPePropertyEditorBlockName_FWD_DEFINED__

#ifdef __cplusplus
typedef class AcPePropertyEditorBlockName AcPePropertyEditorBlockName;
#else
typedef struct AcPePropertyEditorBlockName AcPePropertyEditorBlockName;
#endif /* __cplusplus */

#endif 	/* __AcPePropertyEditorBlockName_FWD_DEFINED__ */
...
#define CLSID_PropertyEditorBlockName CLSID_AcPePropertyEditorBlockName
...
EXTERN_C const CLSID CLSID_AcPePropertyEditorBlockName;

#ifdef __cplusplus

class DECLSPEC_UUID("B8B7F9F3-B947-42C6-BDA5-F1DA94B285BF")
AcPePropertyEditorBlockName;
#endif
