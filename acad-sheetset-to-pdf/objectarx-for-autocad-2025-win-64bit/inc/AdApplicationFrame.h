...
public:
    ...
    /// <summary>
    /// The state of Autodesk Application Frame. 
    /// </summary>                                          
    enum Ad_Frame_States
    {
        kAd_Frame_None = 0,
        kAd_Frame_DisableSize = 1,
        kAd_Frame_DisableMove = 2,
        kAd_Frame_DisableClose = 4,
    };
    ...
    bool SetSmallApplicationButton(HBITMAP hBitmap, 
        HBITMAP hHotBitmap, HBITMAP hSelectedBitmap);
    bool SetApplicationButtonSize(Ad_ApplicationButtonId nButtonId, SIZE size);
