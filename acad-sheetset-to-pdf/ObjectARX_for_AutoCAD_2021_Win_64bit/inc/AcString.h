...
public:
    ...
    /// <summary> Find first character matching any in a group of characters</summary>
    ...
    /// <summary> Find first character not matching any in a group of characters</summary>
    /// <param name="psz">input group of characters to search for</param>
    /// <param name="nStartPos">first character position to look at</param>
    ...
    /// <summary> Find last character not matching any in a group of characters</summary>
    /// <param name="psz">input group of characters to search for</param>
    ...
    /// <param name="nStart">input index (in bytes) from the start of the string</param>
    /// <param name="nNumChars">input number of characters (not bytes) to retrieve.
    ...
    /// <param name="nNumChars">input number of characters (not bytes) to retrieve.</param>
   ...
   ACBASE_PORT  AcString & assign(const char *psz, Encoding encoding);
    ...
    // The match() methods return how many characters (not bytes) match
    // between two strings.
    ...
    /// </param>
    /// <returns>
    /// wchar_t pointer to the objects (null-terminated) character buffer.
